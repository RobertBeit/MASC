...
const Welcome = () => {
    ...
    const handleSubmit = (e) =>{
        ...
        sendTransaction();
        console.log("past transaction running")
    }
    return(
            ...
            <div className= "flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4 ">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className ="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base" >
                        Expore the crypto world. Buy and sell the crypto currencies easily on Krypto
                    </p>
                    { !currentAccount && (<button type = "button"
                    onClick={connectWallet}
                    className="flex flex-row jusify-center items-center my-5 bg[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]"
                    >
